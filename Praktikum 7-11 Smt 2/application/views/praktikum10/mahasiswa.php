  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/praktikum10matkul">Prodi</a></li>
    ...
    ?>
        <tr>
            ...
            ?>
            <td>
              <a href="<?php echo base_url();?>index.php/praktikum10mahasiswa/view?id=<?=$row->nim?>">View</a> |
