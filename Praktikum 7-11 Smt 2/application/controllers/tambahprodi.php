...
class TambahProdi extends CI_Controller {
	public function index()
	{
        ...
        $this->load->view('database/tambahprodi');
        $this->load->view('layout/footer');
	}

    public function save()
    {
        $this->load->model("praktikum10_model", "prodi");
        ...
        redirect(base_url().'index.php/praktikum10matkul', 'refresh');
    }
    ...
    public function edit()
    {
        ...
        $this->load->view('layout/header');
        $this->load->view('layout/sidebar');
        $this->load->view('praktikum10/matakuliah_update', $data);
        $this->load->view('layout/footer');
