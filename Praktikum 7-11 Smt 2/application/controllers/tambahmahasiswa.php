...
class Tambahmahasiswa extends CI_Controller {
	public function index()
	{
        ...
        $this->load->view('database/tambahmahasiswa');
    ...
    public function save()
    {
        ...
        redirect(base_url().'index.php/praktikum10mahasiswa/view?id='.$_nim, 'refresh');
    ...
    public function edit()
    {
        ...
        $this->load->view('layout/header');
        $this->load->view('layout/sidebar');
        $this->load->view('praktikum10/mahasiswa_update', $data);
        $this->load->view('layout/footer');
    }
    ...
    public function delete()
    {
        ...
        redirect(base_url().'index.php/praktikum10mahasiswa', 'refresh');
    }
